...
class SetuInventoryAgeBreakdownReport(models.TransientModel):
    ...
    def get_inventory_age_breakdown_report_data(self):
        ...
        locations = self.location_ids and set(self.location_ids.ids) or {}
        ...
        query = """
                Select * from get_inventory_age_breakdown_data('%s','%s','%s', '%s', '%s', '%s')
            """%(company_ids, products, category_ids, self.breakdown_days, warehouses, locations)
        print(query)
    ...
    def write_report_data_header(self, workbook, worksheet, row):
        ...
        worksheet.write(row, 1, 'Product Code', normal_left_format)
        worksheet.write(row, 2, 'Category', normal_left_format)
        worksheet.write(row, 3, 'Total Stock', odd_normal_right_format)
        worksheet.write(row, 4, 'Stock Value', even_normal_right_format)

        self.set_breakdown_header(workbook, worksheet, row-1, 5, self.get_column_header(1), odd_normal_center_format)
        worksheet.write(row, 5, "Stock" ,odd_normal_right_format)
        worksheet.write(row, 6, "Value", odd_normal_right_format)

        self.set_breakdown_header(workbook, worksheet, row - 1, 7, self.get_column_header(2), even_normal_center_format)
        worksheet.write(row, 7, "Stock", even_normal_right_format)
        worksheet.write(row, 8, "Value", even_normal_right_format)

        self.set_breakdown_header(workbook, worksheet, row - 1, 9, self.get_column_header(3), odd_normal_center_format)
        worksheet.write(row, 9, "Stock", odd_normal_right_format)
        worksheet.write(row, 10, "Value", odd_normal_right_format)

        self.set_breakdown_header(workbook, worksheet, row - 1, 11, self.get_column_header(4), even_normal_center_format)
        worksheet.write(row, 11, "Stock", odd_normal_right_format)
        worksheet.write(row, 12, "Value", odd_normal_right_format)

        self.set_breakdown_header(workbook, worksheet, row - 1, 13, self.get_column_header(5), odd_normal_center_format)
        worksheet.write(row, 13, "Stock", odd_normal_right_format)
        worksheet.write(row, 14, "Value", odd_normal_right_format)

        self.set_breakdown_header(workbook, worksheet, row - 1, 15, self.get_column_header(6), even_normal_center_format)
        worksheet.write(row, 15, "Stock", odd_normal_right_format)
        worksheet.write(row, 16, "Value", odd_normal_right_format)

        self.set_breakdown_header(workbook, worksheet, row - 1, 17, self.get_column_header(7), odd_normal_center_format)
    ...
    def write_data_to_worksheet(self, workbook, worksheet, data, row):
        ...
        worksheet.write(row, 0, product_id.name, normal_left_format)
        ...
        worksheet.write(row, 3, data.get('total_stock',''), odd_normal_right_format)
        worksheet.write(row, 4, data.get('total_stock_value',''), even_normal_right_format)
        worksheet.write(row, 5, data.get('breakdown1_qty',''), odd_normal_right_format)
        worksheet.write(row, 6, data.get('breckdown1_value',''), odd_normal_right_format)
        worksheet.write(row, 7, data.get('breakdown2_qty', ''), even_normal_right_format)
        worksheet.write(row, 8, data.get('breckdown2_value', ''), even_normal_right_format)
        worksheet.write(row, 9, data.get('breakdown3_qty', ''), odd_normal_right_format)
        worksheet.write(row, 10, data.get('breckdown3_value', ''), odd_normal_right_format)
        worksheet.write(row, 11, data.get('breakdown4_qty', ''), even_normal_right_format)
        worksheet.write(row, 12, data.get('breckdown4_value', ''), even_normal_right_format)
        worksheet.write(row, 13, data.get('breakdown5_qty', ''), odd_normal_right_format)
        worksheet.write(row, 14, data.get('breckdown5_value', ''), odd_normal_right_format)
        worksheet.write(row, 15, data.get('breakdown6_qty', ''), even_normal_right_format)
        worksheet.write(row, 16, data.get('breckdown6_value', ''), even_normal_right_format)
        worksheet.write(row, 17, data.get('breakdown7_qty', ''), odd_normal_right_format)
        worksheet.write(row, 18, data.get('breckdown7_value', ''), odd_normal_right_format)
        return worksheet
