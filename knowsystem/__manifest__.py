# -*- coding: utf-8 -*-
{
    ...
    "assets": {
        "web.assets_backend": [
                ...
                "knowsystem/static/src/js/wizard_search_content.js",
    ...
    "summary": "The tool to build deep and structured knowledge base for internal and external use. Knowledge System. KMS. Wiki-like revisions. Documentation.",
