odoo.define("lyon_backend_theme.website_apps_menu", function (require) {
    "use strict";
    /*
     * We can't require anything from website here because `lyon_backend_theme` doesn't depend on `website`.
